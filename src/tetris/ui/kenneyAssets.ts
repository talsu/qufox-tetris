export const KENNEY_UI_IMAGE_KEYS = {
    buttonBlue: 'kenneyUiButtonBlue',
    buttonRed: 'kenneyUiButtonRed',
    buttonGreen: 'kenneyUiButtonGreen',
} as const;

const KENNEY_UI_IMAGE_PATHS: Record<(typeof KENNEY_UI_IMAGE_KEYS)[keyof typeof KENNEY_UI_IMAGE_KEYS], string> = {
    [KENNEY_UI_IMAGE_KEYS.buttonBlue]: '/assets/image/ui-pack/PNG/Blue/Double/button_rectangle_depth_gloss.png',
    [KENNEY_UI_IMAGE_KEYS.buttonRed]: '/assets/image/ui-pack/PNG/Red/Double/button_rectangle_depth_gloss.png',
    [KENNEY_UI_IMAGE_KEYS.buttonGreen]: '/assets/image/ui-pack/PNG/Green/Double/button_rectangle_depth_gloss.png',
};
